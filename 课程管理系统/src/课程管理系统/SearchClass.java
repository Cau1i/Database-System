...
public class SearchClass extends Menu {
	...
	public static String sql = "select student.Sname,course.Cname from course,sc,student where course.Cno=sc.Cno and sc.Sno=student.Sno";// 要执行的语句
	JFrame jf = new JFrame("每个学生其选修的课程");
